...
export class ProductEditor implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.editorForm = new FormGroup({
      ...
      weightInKg: new FormControl(this.product() != null ? this.product()?.detail.weightInKg : "", [Validators.required]),
      material: new FormControl(this.product() != null ? this.product()?.detail.material : "", [Validators.required]),
      lengthInCm: new FormControl(this.product() != null ? this.product()?.detail.lengthInCm : "", [Validators.required]),
      heightInCm: new FormControl(this.product() != null ? this.product()?.detail.heightInCm : "", [Validators.required]),
      widthInCm: new FormControl(this.product() != null ? this.product()?.detail.widthInCm : "", [Validators.required]),
      size: new FormControl(this.product() != null ? this.product()?.detail.size : "", [Validators.required]),
      isSet: new FormControl(this.product() != null ? this.product()?.detail.isSet : false, [Validators.required]),
      stockKeepingUnit: new FormControl(this.product() != null ? this.product()?.stockKeepingUnit : false, [Validators.required]),
