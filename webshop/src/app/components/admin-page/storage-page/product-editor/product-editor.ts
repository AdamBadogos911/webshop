...
export class ProductEditor implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.editorForm = new FormGroup({
      ...
      weightInKg: new FormControl(this.product() != null ? this.product()?.detail.weightInKg : "", []),
      material: new FormControl(this.product() != null ? this.product()?.detail.material : "", []),
      lengthInCm: new FormControl(this.product() != null ? this.product()?.detail.lengthInCm : "", []),
      heightInCm: new FormControl(this.product() != null ? this.product()?.detail.heightInCm : "", []),
